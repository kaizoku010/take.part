      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            <a id="link onClick={() => scrollToSection('hero')} className="hover:text-yellow-400 transition-colors cursor-pointer">Home</a>
            <a onClick={() => scrollToSection('about')} className="hover:text-yellow-400 transition-colors cursor-pointer">About</a>
            <a onClick={() => scrollToSection('prizes')} className="hover:text-yellow-400 transition-colors cursor-pointer">Prizes</a>
