        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/stories" className="text-gray-300 hover:text-yellow-400 transition-colors">Stories</Link></li>
              <li><Link to="/submit-story" className="text-gray-300 hover:text-yellow-400 transition-colors">Submit Story</Link></li>
