...
const Footer = () => {
  return (
    <footer id="footer" className="bg-green-900 text-white py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Tell Your Story UG</h3>
            <p className="text-gray-300 text-gray-hound">
            Tell Your Story UG is an exciting digital campaign designed to showcase the beauty, adventure, and culture of Uganda through the eyes of its travelers. We invite everyone (locals, tourists, and travel enthusiasts) to share their unique Ugandan tourism experiences and inspire others to explore the Pearl of Africa.
                        </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-gray-300 text-gray-hound">
              Email: <a href="mailto:info@tellyourstoryug.com" className="text-gray-hound hover:text-yellow-400 transition-colors">info@tellyourstoryug.com</a>
            </p>
          </div>
        </div>
        
        <div className="mt-8 pt-4 border-t border-green-800 text-center text-gray-300 text-gray-hound">
