        ...
        {isMenuOpen && (
          <nav className="md:hidden pt-4 pb-2">
            <div className="flex flex-col space-y-3">
              <a onClick={() => scrollToSection('hero')} id=" className="hover:text-yellow-400 transition-colors py-2 cursor-pointer">Home</a>
              <a onClick={() => scrollToSection('about')} id=" className="hover:text-yellow-400 transition-colors py-2 cursor-pointer">About</a>
