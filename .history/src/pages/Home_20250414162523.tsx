            ...
            <div className="max-w-3xl mx-auto text-gray-700">
              <Accordion type="single" collapsible>
                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent>
                  <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
<p>                    All submitted content must be original and related to tourism experiences in Uganda. Content must not violate any copyright laws or contain inappropriate material.
</p>                      
                    </div>
                  </AccordionContent>
                </AccordionItem>
