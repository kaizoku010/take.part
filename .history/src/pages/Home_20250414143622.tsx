    ...
    <Layout>
      ...
      <section className="relative h-[80vh] bg-cover bg-center flex items-center" 
        ...
        <div className="container mx-auto px-4 text-center text-white">
          ...
          <p id="hero-text" className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto drop-shadow-md">
      ...
      {/* Carousel */}
      <section id="carousel-section" className="py-16 bg-green-800 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
...
alt="Uganda landscape" 
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-green-800 mb-6">Ready to Share Your Uganda Experience?</h2>
