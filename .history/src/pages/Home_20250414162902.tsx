            ...
            <div className="max-w-3xl mx-auto text-gray-700">
              <Accordion type="single" collapsible>
                ...
                <AccordionItem value="item-3">
                  <AccordionTrigger>3. CONTENT GUIDELINES </AccordionTrigger>
                  <AccordionContent>
                    By submitting content, you grant Tell Your Story UG the
                    right to use, modify, and share your content across our
                    platforms for campaign purposes.
                  </AccordionContent>
                </AccordionItem>
