            ...
            <div className="max-w-3xl mx-auto text-gray-700">
              <Accordion type="single" collapsible>
                ...
                <AccordionItem value="item-2">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
<p>  
To enter the campaign, participants must:</p>      
<li>Share a personal travel, cultural, or tourism-related story from Uganda (or applicable country/region) </li>
                    <li>
                    Use the official campaign hashtags: #TellYourStory and #ExploreUganda 

</li>
                    <li>
                      Media platform (e.g. Instagram, Facebook, TikTok, X/Twitter, YouTube)</li>                
                    </div>
                  </AccordionContent>
                </AccordionItem>
