                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent>
                    ...
                    >
                      ...
                      <li>Ensure their profile/post is public for visibility </li>
                      <p>
                      Content formats may include videos, reels, photos with captions, blog posts, or vlogs. 
                      </p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent>
                    ...
                    >
                      ...
                      <li>
                      Are original, owned by the participant, and do not infringe on any third-party rights. Do not

                      </li>
                      <li>
                      contain offensive, hateful, defamatory, or illegal material. Reflect positive, authentic, and

                      </li>
                      <li>
                      inspiring experiences related to travel, culture, or personal stories                      </li>
                      <li>Respect the privacy and intellectual property of others.</li>
                      <p>
                      Include proper credits where applicable (e.g., if someone else filmed or photographed the content).                      </p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
