            ...
            <div className="max-w-3xl mx-auto text-gray-700">
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    The campaign is open to all individuals aged 18 and above. Participants must have valid social media accounts and must follow our official campaign pages.
                  </AccordionContent>
                </AccordionItem>
