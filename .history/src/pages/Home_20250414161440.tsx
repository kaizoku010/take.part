...
const Home = () => {
  return (
    <Layout>
      {/* Hero Section */}
      <section className="hero relative h-[80vh] bg-cover bg-center flex items-center" 
        style={{ 
      ...
      {/* About Section */}
      <section className="py-16 bg-green-50 about-section">
...
alt="Uganda landscape" 
      ...
      <section id="prizes-section prizes">
